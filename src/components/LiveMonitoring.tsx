...
export const LiveMonitoring: React.FC<LiveMonitoringProps> = ({ stats, onRefresh }) => {
  ...
  useEffect(() => {
    ...
    if (timeUntilReset && timeUntilReset < 3600000) { // Less than 1 hour
  ...
  const timeProgress = stats.resetInfo ? 
    Math.max(0, Math.min(100, ((24 * 60 * 60 * 1000 - stats.resetInfo.timeUntilReset) / (24 * 60 * 60 * 1000)) * 100)) : 0;
      ...
      <div className="glass-card p-5">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="glass p-4 rounded-xl">
            ...
            <div className="text-xs text-neutral-400">
              {stats.resetInfo ? formatTimeRemaining(stats.resetInfo.timeUntilReset) : 'No reset info'} until reset
            </div>
          </div>
        </div>
      </div>
