      ...
      <div className="glass-card p-8 text-center max-w-sm w-full glass-interactive">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            <div className="w-16 h-16 rounded-2xl flex items-center justify-center floating" style={{ background: 'var(--gradient-primary)' }}>
        ...
        <div className="space-y-2 text-left">
          <div className="flex items-center space-x-3 text-sm">
            <div className="w-2 h-2 rounded-full animate-pulse" style={{ backgroundColor: 'var(--color-success-light)' }} />
