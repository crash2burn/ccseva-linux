...
const NotificationItem: React.FC<{
  ...
  const getColorClasses = () => {
    switch (notification.type) {
      case 'success': return 'border-green-400/30 bg-green-500/20';
      case 'warning': return 'border-yellow-400/30 bg-yellow-500/20';
      case 'error': return 'border-red-400/30 bg-red-500/20';
      default: return 'border-blue-400/30 bg-blue-500/20';
    }
  };
